...
By submitting a contribution (pull request, patch, or other code) to the Floxy Manager project,
you agree that:

1. You have the legal right to contribute the code.
2. Your contribution is licensed under the Floxy Business License (FBL), and may be used,
...
3. The project owner may also include your contribution in future commercial licenses or
   ...
   compensation.
4. You retain copyright and authorship of your contribution, which will remain visible in the Git history.
